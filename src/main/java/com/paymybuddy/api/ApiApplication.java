...
public class ApiApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		 ...
		 * userContact.setFirstName("firstname1"); userContact.setLastName("lastname1");
		 */
		 ...
		 * bankingAccountUser2.setId(76001); bankingAccountUser2.setUser(userTest2);
		 * bankingAccountUser2.setBalance(64569);
		 * bankingAccountUser2.setType("Banking Account");
		 */

		// BankAccount bankAccount = new
		// BankAccount(100824,"testuser2@gmail.com",787378.0124);
